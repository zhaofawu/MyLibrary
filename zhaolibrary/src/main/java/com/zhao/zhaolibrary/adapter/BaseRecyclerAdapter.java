package com.zhao.zhaolibrary.adapter;
...
import com.zhao.zhaolibrary.adapter.animation.AlphaInAnimation;
import com.zhao.zhaolibrary.adapter.animation.AnimationType;
import com.zhao.zhaolibrary.adapter.animation.BaseAnimation;
import com.zhao.zhaolibrary.adapter.animation.CustomAnimation;
import com.zhao.zhaolibrary.adapter.animation.ScaleInAnimation;
import com.zhao.zhaolibrary.adapter.animation.SlideInBottomAnimation;
import com.zhao.zhaolibrary.adapter.animation.SlideInLeftAnimation;
import com.zhao.zhaolibrary.adapter.animation.SlideInRightAnimation;
import com.zhao.zhaolibrary.adapter.animation.SlideInTopAnimation;
import com.zhao.zhaolibrary.adapter.listener.OnDragAndSwipeListener;
import com.zhao.zhaolibrary.adapter.listener.OnRecyclerItemClickListener;
import com.zhao.zhaolibrary.adapter.listener.OnRecyclerItemLongClickListener;
import com.zhao.zhaolibrary.adapter.listener.RequestLoadMoreListener;
import com.zhao.zhaolibrary.adapter.view.FooterView;
import com.zhao.zhaolibrary.adapter.view.LoadType;
...
/**
 * https://github.com/zhangke3016/MultilevelTreeList
 */
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnDragAndSwipeListener {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        switch (mViewType) {
            ...
            default:
            case VIEW_TYPE_CONTENT:
                convert((BaseViewHolder) holder, mData.get(holder.getLayoutPosition() - getHeaderViewCount()),holder.getLayoutPosition() - getHeaderViewCount());
