...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public BaseViewHolder append(int viewId, CharSequence text) {
     ...
     * @return
     */
    public BaseViewHolder setImageResource(int viewId, String url) {
        ImageView view = getView(viewId);
        Picasso.with(getConvertView().getContext()).load(url).centerCrop().fit().into(view);
        return this;
    }
     ...
     * @return
     */
    public BaseViewHolder setRVAdapter(Context context,int viewId, BaseRecyclerAdapter adapter) {
