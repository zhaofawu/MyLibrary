package com.zhao.zhaolibrary.snapview.widget;
...
public class SnapPageLayout extends ViewGroup {
	...
	private List<SnapPage> allPages;

	private PageSnapListener mPageSnapListener;
	...
	public void setPageSnapListener(PageSnapListener listener){
		mPageSnapListener = listener;
    }
	 ...
	 * @param SnapPage
     */
	public void addSnapPage(SnapPage SnapPage){
		allPages.add(SnapPage);

		addView(SnapPage.getRootView());
	...
	public void computeScroll() {
		...
		if (mScroller.computeScrollOffset()) {
			if (mScroller.getCurrY() == (mScroller.getFinalY())) {
				...
				if(mPageSnapListener != null){
					mPageSnapListener.onSnapedCompleted(mFlipDrection);
				}
			}
	...
	public SnapPage getCurrentSnapPage() {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		LogUtil.e("onTouchEvent--" + System.currentTimeMillis());
    ...
    private void snapToDestination() {
		...
		LogUtil.e("snapToDestination mCurrentScreen = " + mCurrentScreen);
    	LogUtil.e("snapToDestination whichScreen = " + whichScreen);
	...
	private void snapToScreen(int pageIndex) {
        ...
        LogUtil.e("the newY is " + newY + " cy is " + cy);
		...
		if(pageListener!=null){
			pageListener.pageIndex(mCurrentScreen);
		}
        invalidate();
    }
