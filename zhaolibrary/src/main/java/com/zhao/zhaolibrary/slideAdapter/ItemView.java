...
public class ItemView extends RecyclerView.ViewHolder {
    ...
    static ItemView create(@NonNull Context context, @NonNull ViewGroup parent, @NonNull final SlideItem slideItem) {
        final View itemView = LayoutInflater.from(context).inflate(R.layout.slide_layout, parent, false);
    ...
    public ItemView setOnClickListener(final View.OnClickListener listener) {
        ((SlideLayout) getView(R.id.slideLayout)).setCustomOnClickListener(
    ...
    public ItemView closeMenu() {
        ((SlideLayout) getView(R.id.slideLayout)).getAdapter().closeOpenItem();
        return this;
    }
