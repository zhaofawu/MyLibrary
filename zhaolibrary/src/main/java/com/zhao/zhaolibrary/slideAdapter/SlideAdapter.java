package com.zhao.zhaolibrary.slideAdapter;
...
import com.zhao.zhaolibrary.adapter.decoration.RecycleViewDivider;
...
public class SlideAdapter extends RecyclerView.Adapter<ItemView> {
    ...
    private void initLeftRightMenu(ItemView holder, int position) {
        ...
        if (rightMenu != null) {
            ...
            ((SlideLayout) holder.getView(R.id.slideLayout)).setRightMenuWidth(rightMenuParams.width);
        }
        ...
        if (leftMenu != null) {
            ...
            holder.getView(R.id.slideLayout).scrollTo(leftMenuParams.width, 0);
            ((SlideLayout) holder.getView(R.id.slideLayout)).setLeftMenuWidth(leftMenuParams.width);
        }
    }
