package com.zhao.zhaolibrary.View.ImageCycleView;
...
public class ImageCycleView<T> extends LinearLayout {
	 ...
	 * 是否轮播滚动
	 */
	private boolean isImageCycle=false;
	public boolean isImageCycle() {
		return isImageCycle;
	}

	public void setImageCycle(boolean imageCycle) {
		isImageCycle = imageCycle;
	}
     ...
     */
	public void setImageResources(ArrayList<T> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
...
//		}
	...
	private class ImageCycleAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, final int position)   {
			...
			if(!mAdList.isEmpty()) {
				mImageCycleViewListener.displayImage(mAdList.get(position), imageView);
			}
			return imageView;
		}
	...
	public  interface ImageCycleViewListener<T> {
		 ...
		 * @param imageView
		 */
		 void displayImage(T info, ImageView imageView);
